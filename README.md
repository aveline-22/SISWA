...
*GET /todos*  
![GET /todos](./secrenshoot/Get ToDos.png)

*POST /todos*  
![POST /todos](./screenshots/post-todos.png)

*PUT /todos/:id*  
![PUT /todos/:id](./screenshots/put-todos.png)

*DELETE /todos/:id*  
![DELETE /todos/:id](./screenshots/delete-todos.png)
